...
build_ios_arch() {
  ...
  OPENSSLDIR_IOS_ARCH_WORKSPACE=${CWD}/build/ios_${ARCH?}
  OPENSSLDIR_IOS_ARCH=${CWD}/output/ios_${ARCH?}
...
build_ios() {
  OPENSSLDIR_IOS=${CWD}/output/ios
  OPENSSLDIR_IOS_ARM64=${CWD}/output/ios_arm64
  OPENSSLDIR_IOS_X86_64=${CWD}/output/ios_x86_64
  ...
  tar -C ${OPENSSLDIR_IOS_ARM64?} -cf - include | tar -C ${OPENSSLDIR_IOS?} -xf -
...
deploy_ios() {
  ...
  tar -C ${OPENSSLDIR_IOS?} -cf - lib include | tar -C ${OPENSSLDIR?} -xf -
}
